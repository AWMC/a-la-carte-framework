...
$query .= " AND ";
    ...
    $query .= " ST_Intersects(pplaces.the_geom_disp, ST_PolygonFromText('$geomParam', 4326))";
    $queryadd++;
}

$query .=" group by pplaces.pid, pplaces.en_name, pplaces.gr_name, pplaces.la_name, pplaces.featuretyp, pplaces.timeperiod, pplaces.perseus_li, pplaces.wiki_link, pplaces.path, pplaces.greek_map, geom order by en_name";
